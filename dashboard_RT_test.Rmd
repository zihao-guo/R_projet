...
checkboxInput('NA', "Display real/imputed values", value = TRUE)
...
```{r}
plot_ly(data2_2, labels = ~type_de_traitement , values = ~proportion, type = 'pie')
```
...
### Comparison of different age groups
```{r}
p <- ggplot(data=data2_1, aes(x = Age , y = Nombre, fill = Genre)) +
